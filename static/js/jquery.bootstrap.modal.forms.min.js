    ...
    n=function(n,t){
        o.ajax({
            ...
            success:function(e){
                ...
                o(n.modalForm).attr("action",n.formURL),a(n)):t(n)
            }
        })
    },
    t=function(n){
        if(n.asyncUpdate){
            if(e(n.asyncSettings)){
                ...
                o.ajax({
                    type:o(n.modalForm).attr("method"),
                    url:o(n.modalForm).attr("action"),
                    data:s,contentType:!1,processData:!1,
                    success:function(e){
                        var s=o("body");
                        ...
                        o.ajax({
                            ...
                            success:function(e){
                                ...
                                t.closeOnSubmit?o(n.modalID).modal("hide"):o(n.modalID).find(n.modalContent).load(n.formURL,
                                    function(){
    ...
    o.fn.modalForm=function(n){
        ...
        return this.each(function(){
            o(this).click(function(n){
                !function(n){
                    o(n.modalID).find(n.modalContent).load(n.formURL,
                    function(){
